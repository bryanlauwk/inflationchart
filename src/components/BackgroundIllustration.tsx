 ...
 * Rendered at low opacity so they enhance without competing with data.
...
export function HeroIllustration({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <svg
        viewBox="0 0 800 400"
        className="absolute right-0 top-1/2 h-full w-auto -translate-y-1/2 opacity-[0.06] md:opacity-[0.08]"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        ...
        <g stroke="hsl(var(--primary))" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Steam wisps */}
          <path d="M360 190 Q355 160 365 140" strokeWidth="1.2" opacity="0.7" />
          <path d="M400 185 Q398 150 405 125" strokeWidth="1.2" opacity="0.7" />
          <path d="M440 190 Q445 155 438 135" strokeWidth="1.2" opacity="0.7" />
        </g>
...
export function FooterMotifs({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      >
        {/* Small leaf sprigs */}
        <g stroke="hsl(var(--primary))" strokeLinecap="round" opacity="0.1" strokeWidth="1.2">
          {/* Left sprig */}
          ...
          <circle cx="300" cy="30" r="1.5" fill="hsl(var(--primary))" stroke="none" />
          <circle cx="290" cy="28" r="1" fill="hsl(var(--primary))" stroke="none" />
          <circle cx="310" cy="28" r="1" fill="hsl(var(--primary))" stroke="none" />
          <circle cx="295" cy="35" r="1.2" fill="hsl(var(--primary))" stroke="none" />
          <circle cx="305" cy="35" r="1.2" fill="hsl(var(--primary))" stroke="none" />
